...
external decode_count1_quants_unsafe : Ptr.t -> int -> int -> Ptr.t -> int -> int -> bool -> int * int = "mfh_decode_count1_quants_bytecode" "mfh_decode_count1_quants";;
let decode_count1_quants in_ptr in_bit_off in_bit_off_to out_ptr out_quant_off out_quant_off_to ht1 decoder_error_ref =
	...
	let (new_ptr_loc, new_index) = ret in
