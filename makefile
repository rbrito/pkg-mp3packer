...
mp3packer: crc.cmx list2.cmx expandarray.cmx c_part$(OBJ_EXT) mp3types.cmx pack.cmx mp3read.cmx mp3info.cmx mp3framehuffman.cmx mp3frameutils.cmx mp3queue.cmx mp3packer.ml
	ocamlopt -o mp3packer unix.cmxa str.cmxa crc.cmx list2.cmx expandarray.cmx c_part$(OBJ_EXT) mp3types.cmx pack.cmx mp3read.cmx mp3info.cmx mp3framehuffman.cmx mp3frameutils.cmx mp3queue.cmx mp3packer.ml
...
mp3reader: crc.cmx list2.cmx c_part$(OBJ_EXT) mp3types.cmx pack.cmx mp3read.cmx mp3reader.ml
	ocamlopt -o mp3reader unix.cmxa crc.cmx list2.cmx c_part$(OBJ_EXT) mp3types.cmx pack.cmx mp3read.cmx mp3reader.ml
...
mp3framehuffmantest: mp3types.cmx pack.cmx mp3framehuffman.cmx mp3framehuffmantest.ml
	ocamlopt -o mp3framehuffmantest unix.cmxa str.cmxa mp3types.cmx pack.cmx mp3framehuffman.cmx mp3framehuffmantest.ml
...
mp3queue_test: mp3types.cmx crc.cmx pack.cmx mp3read.cmx mp3framehuffman.cmx mp3frameutils.cmx mp3queue.cmx mp3queue_test.ml
	ocamlopt -o mp3queue_test mp3types.cmx crc.cmx pack.cmx mp3read.cmx mp3framehuffman.cmx mp3frameutils.cmx mp3queue.cmx mp3queue_test.ml
	mp3queue_test

mp3info_test: crc.cmx mp3types.cmx pack.cmx mp3read.cmx mp3info.cmx mp3info_test.ml
	ocamlopt -o mp3info_test crc.cmx mp3types.cmx pack.cmx mp3read.cmx mp3info.cmx mp3info_test.ml
	mp3info_test

mp3queue_concept: mp3queue_concept.ml
	ocamlopt -o mp3queue_concept mp3queue_concept.ml
	mp3queue_concept
